...
public class Main
{
    public static void main(String[] args)
    {
        try
        {
            ...
            {
                StringTokenizer st = new StringTokenizer (inData, ";"); custName = st.nextToken();
                ...
                {
                    code = st.nextToken();
                    customer[i]= new Member (custName, day, month, year, member, 
                    dessertType, flavor, size, topping, code, payment);
                }
                else
                {
                    ...
                    customer[i] = new NonMember(custName, day, month, year, discountCode, 
                    dessertType ,flavor, size, topping, discCode, payment);
            ...
            for(int x=0; x < customer.length; x++)
            {
                ...
                df.format(customer[x].calcFinalPrice()) + "\n");
            }
